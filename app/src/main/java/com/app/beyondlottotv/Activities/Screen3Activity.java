...
public class Screen3Activity extends AppCompatActivity {
    ...
    private void getSetUserData() {
        AppRepository.getUser(Screen3Activity.this, Screen3Activity.this, "screen3", (status, user) -> {
            if (status) {
                ...
                this.runOnUiThread(() -> {
                    ...
                    if (user.getScreen3().getBox_settings().size() > 0){
...
//                        }
    ...
    //khokhar@2921
    public static void initrecycler(Context context, Screen1 screen3, Boolean showheader, String orientation, int boxes, String empty_box, String imageurl) {
        if (screen3.getBox_settings().isEmpty()){
            pbar.setVisibility(View.GONE);
            return;
        }
