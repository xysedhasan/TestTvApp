...
public class Screen4Activity extends AppCompatActivity {
    ...
    private void getSetUserData() {
        AppRepository.getUser(Screen4Activity.this, Screen4Activity.this, "screen4", (status, user) -> {
            if (status) {
...
//                        }
    ...
    //khokhar@2921
    public static void initrecycler(Context context, Screen1 screen4, Boolean showheader, String orientation, int boxes, String empty_box, String imageurl) {
        if (screen4.getBox_settings().isEmpty()){
        ...
        GridAdapter adpter = new GridAdapter(context,true, "4", screen4, sizeoflyt, orientation, boxes, empty_box, imageurl);
